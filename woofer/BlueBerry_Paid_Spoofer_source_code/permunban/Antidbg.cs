...
namespace AntiCrack_DotNet
{
	class AntiDebug
	{
		...
		public static bool FindWindowAntiDebug()
		{
			...
			{
				string[] BadWindowNames = { "x32dbg", "x64dbg", "windbg", "ollydbg", "dnspy", "immunity debugger", "hyperdbg", "debug", "debugger", "cheat engine", "cheatengine", "ida", "ida64", "idag", "idag64", "idaw", "idaq", "idaw64", "idau", "idau64", "scylla", "scylla_x64", "scylla_x86", "protection_id", "reshacker", "diacane", "ProcessHacker", "ImportRec", "IMMUNITYDEBUGGER", "MegaDumper", "KsDumperClient", "KsDumper", "Wireshark", "Fiddler", "FiddlerEverywhere", "Xenos", "Xenox64", "Xenox32", "de4dot", "FreeTools.ioFolderViewer", "FolderViewer", "cheatengine-x86_64", "cheatengine-x86_64-SSE4-AVX2", "Cheat Engine", "MugenJinFuu-x86_64-SSE4-AVX2", "MugenJinFuu-i386", "cheatengine-x86_64", "cheatengine-i386", "VB Decompiler", "pexplorer", "HDasm", "SourceRescuer", "dnSpy", "dnSpy-x86", "DeDe", "DotNetResolver", "Reflector", "P32Dasm", "kWdsm", "VBExplorer v1.1", "VB.Decompiler.Pro.v10.0.KEYGEN-FFF", "krzloaddll", "krzydbg", "4fr33", "StringDecryptor", "ExtremeDumper", "KDT", "AntiTamperKiller", "AntiTampRem", "CFF Explorer", "PE-bear", "HxD32", "HxD64", "BConv32", "Tutorial", "dbpwd", "accesspv", "WinSpy32", "WinSpy64", "WinSpy 1.8.9 beta", "Au3Info_x32", "Au3Info_x64", "hdd", "Procmon", "Procmon64", "USSF", "DnsJumper", "CryptoTester", "ConverterNET x64", "CABPACK", "HostsEditor", "HideToolz", "ASPatcher1.2", "dup2", "alg", "abel_loader_generator", "niffer Maker", "Loader.Generator.v1.3", "exeinfope", "EXEconfig", "nfd", "Protection_ID", "RDG Packer Detector v0.7.6", "Unpacker_PECompact", "Unpecomp2", "WSUnpacker", "xvlk", "UPXUnPacKer.V0.3.By.skylly", "UPXEasyGUI", "upx_unpacker", "UntElock 0.98+", "RlpackUnpacker", "ObsidiumUnpacker", "MART!K UnPacker", "NoFuserEx", "NoFuser", "NetGuard Deobfuscator 2", "sample_x86", "ILPUnpacker", "ConfuserEx Dynamic Unpacker", "UnConfuserEx", "ResourceHacker", "apkeasytool", "apkeasytool-x64", "jadx-gui-0.9.0", "FolderViewerud", "Folderviewchanges", "FreeTools.ioDriverPuller", "HTTPDebuggerUI", "vsd_win32", "ARTeamImportReconstructor", "WebCruiserWVS", "Extreme Injector v3", "HxD64", "HxD32", "die" };
