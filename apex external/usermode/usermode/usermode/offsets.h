...
namespace Offsets {
	...
	static DWORD ViewRender = 0x763f830;//updated
	...
	static DWORD m_iMaxHealth = 0x578;//updated
	static DWORD m_shieldHealth = 0x170;//updated
	static DWORD m_shieldHealthMax = 0x174;//updated
	static DWORD CPlayerarmorType = 0x45bc;//updated
	static DWORD m_thirdPersonShoulderView = 0x36a0;//updated
	static DWORD thirdperson_override = 0x01af2520;//updated
	...
	static DWORD NameList = 0xbbd1840; // updated
}
